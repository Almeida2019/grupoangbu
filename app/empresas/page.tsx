...
import { ArrowRight, Computer, Wrench, GraduationCapIcon as Graduation, Wifi, Building, Wheat } from "lucide-react"
          ...
          <div className="grid gap-12">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="flex items-center justify-center">
                <Image
                  src="/images/Angbu Comércio.webp"
                  alt="Angbu Comércio - Loja de Informática e Telecomunicações"
                  width={500}
                  height={500}
              ...
              <div className="flex flex-col justify-center">
                <div className="mb-4 flex items-center">
                  <Computer className="mr-3 h-8 w-8 text-angbu-orange" />
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="flex items-center justify-center">
                <Image
                  src="/images/Angbu Telecomunicação e Electrónica.webp"
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="order-2 flex items-center justify-center md:order-1">
                <Image
                  src="/images/Angbu Training Center (ATC).webp"
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="order-2 flex items-center justify-center md:order-1">
                <Image
                  src="/images/Angbu Empreitada.webp"
                  alt="Angbu Empreitada"
                  width={500}
                  height={500}
                  className="rounded-lg object-cover"
                />
